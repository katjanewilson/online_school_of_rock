...
<h2>The virtual communities that shape our future Joan Jetts and Eric Claptons </h2>
...
How is your quarantine hobby going? For many of those stuck at home over these months, the extra time has been an excuse to return to that <a href= "https://www.vice.com/en_us/article/y3zg8y/hobbies-to-try-during-quarantine-how-it-worked-out"  target = "_blank"> old hobby </a> we gave up on in high school, or try up something entirely new <a href = "https://www.youtube.com/watch?v=avOUFvrmNfQ"  target = "_blank">(napkin folding?) </a>

One of the hobby businesses that has grown in the pandemic recession over the last few months? <a href = "https://www.nytimes.com/2020/09/08/style/guitar-sales-fender-gibson.html"  target = "_blank">Guitars. </a> Andy Mooney, CEO of Fender suggests that this "will be the biggest year of sales in history". With this excitement over guitars comes an important consideration: how to actually play it. 

Of course we all wish we had <a href = "https://www.youtube.com/watch?v=ZoZBI52KmDo"target = "_blank">Jack Black </a> as our substitute rock teacher, but in the mean time, many people have turned to the global classroom: YouTube. With thousands of videos on guitar and other instruments, the content easily adds up to hours of videos, ranging from music theory to scale development to a three part lesson of <a href = "hhttps://www.youtube.com/watch?v=1ftNauLjorY"target = "_blank">the Stairway to Heaven lead part </a>. The top teachers gross over 2 million subscribers and more than 1,000 videos each.

Don't confuse more content or accessibility with making something "easier" to learn, though. Without the right focus skills and the support, it's hard to stick with any instrument, especially guitar. Jimi Hendrix once said that “sometimes you'll want to give up on the guitar, you'll hate the guitar”. The six string is a notoriously difficult instrument to learn, with unnatural strumming patterns and a non-intuititive fretboard. It truly does take a lifetime. 

But Hendrix also said, “...if you stick with it, you’re gonna be rewarded”. If we better understand these online learners, we hope to be reward too: the next Paul McArtney or Bonnie Raitt is making the most of their quarantine time right now. So we looked at over 4,000 comments from 100 videos on YouTube of the most popular channels, <a href="https://www.youtube.com/channel/UCmnlTWVJysjWPFiZhQ5uudg" target = "_blank">Marty Shwartz</a>, <a href="https://www.youtube.com/user/JustinSandercoe" target = "_blank">Justin Guitar</a>, and <a href="https://www.youtube.com/user/andycrowley" target = "_blank">Andy Guitar</a>.
...
The <a href="https://en.wikipedia.org/wiki/Zone_of_proximal_development/" target = "_blank">Zone of Proximal Development</a>, coined by educational psychologist Lev Vygotsky, refers to the sweet spot of instruction between something being too easy and too hard. Think of that moment right before the parent takes their hand off of the back of a child's bike for the first time. In the space between completing a task without the assistance of the teacher or parent or peer, and completing the task independently, is where true learning occurs. 

Teachers already know this, and place students in targeted, differentiated instruction groups all the time. YouTube teachers, on the other hand, make content for a broad audience. While they often do their best to curate an ordered playlist, or group videos by skill level, the choice is really the student's to monitor their own learning, and find that sweet spot between too hard and too easy.

Teachers know that "this is not in the Zone of my Proximal Development" is not usually what students realistically say when judging their own learning performance. Instead, what we hear is "this is too hard" or "this is too easy". We matched the sentiment of video comments with the popular NLP library, <a href="http://www2.imm.dtu.dk/pubdb/edoc/imm6006.pdf" target = "_blank">AFINN</a>, which assigns words on a -5 to 5 scale, with 4 being the most positive comments, and -4 being the most negative.
...
p1 <- ggplot(data = super_both_comment_level_hard, aes(x=factor_sentiment,
  ...
  labs(caption = "Distribution of comments by length, measured in number of words, and sentiment score, from -5 as the lowest sentiment, to +5 is the highest.")
p1
...
More than just having the right content, it is also what the learnger things about themselves. Another psychologist, Albert Bandura, coined the term <a href="https://en.wikipedia.org/wiki/Self-efficacy" target = "_blank">self-efficacy</a>. to refer to a belief in one's abilities. Think of this as the "I think I can". But recent work in ed psych has connected this simple belief to the specific “interpretation of difficulty” within a situation. When we encounter hard things, is that a sign that we are learning, or that we should give up the guitar and choose something else?
...
The graph shows the liklihood of each group expressing words in the group. Those shorter comments towards the left hand side? An inclination of students cursing. Laughter is more prevalent in our high sentiment groups. 
...
And of course we have our braggers, the "it was too easy, bro" doesn't go unnoticed. Which brings us to the teacher's pet. So, while it may be a while until in class guitar groups resume, for now we can celebrate the online teachers who make this community possible. The love is going on beyond the scenes.

Skill development is of particular interest here. Notice the low probability of mentioning anything about the pentatonics of scales for students with negative comments. This suggests another learning theory "it's hard to know what you know and what you don't know". Identifying words, or gaps, is important, and a source of frustration for new lerners is simply not having the vocabulray to express what it is you still need to learn.

We are in a new age of learning communities, and forming a “one world schoolhouse”, as Sal Khan put it, the creator of Khan Academy. Indeed, nothing will ever truly replace the brick and mortar classroom, or the work of a human teacher. But in the time in between, understanding the interactions between people in these communities will certainly lead to better learning outcomes in the long run.

It's hard to imagine that this trend will not continue. Learning for more than K-12 students has moved online, and it will continue to shift the responsibility of the learner in navigating these online communities.
...
```{r, out.width=600, echo=F, fig.cap= "Google Trend search for 'learn guitar' peak every year over the holiday season. This March, the search nearly reached its holiday level from a few months before."}
knitr::include_graphics("images/learn.png")
```

Of course, just like a live stream concert will never replace an in person experience, a YouTube lesson will never replace direct instruction. But, there is something to be said for figuring it out on your own, or, rather, alongside a thousand other classmates from around the world.
...
This is a draft of a pitch for a data journalism essay to FiveThirtyEight. If the piece were to be accepted, I would increase the number of videos, and share code/data with FiveThirtyEight.

I am a PhD student in Quant Methods at Penn, and play guitar in a band on the side!
